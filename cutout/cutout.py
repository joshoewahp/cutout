...
class Cutout:
    ...
    def __getattr__(self, name):
        """Overload __getattr__ to make CutoutAPI attributes accessible directly from Cutout."""
    ...
    def _get_cutout(self):
        ...
        elif any(c in self.survey for c in ['racs', 'vast', 'vlass', 'gw', 'dwf', 'swagx']):
...
class ContourCutout(Cutout):
    ...
    def plot(self, fig=None, ax=None):
        ...
        contourwidth = self.options.get('contourwidth', 3)
        color = 'k' if self.cmap == 'coolwarm' else 'orange'
